...
function checklistItem(id, text, categoryId, quantity, completed) {
            ...
            recommended: [
                {
                    ...
                    rationale: "Cool evenings plus on-and-off rain means you’ll stay comfortable by combining warmth and quick-drying outerwear.",
                },
                {
                    id: "ps-walkcomfort",
                    text: "Prioritize walking comfort",
                    rationale: "Expect lots of walking; supportive footwear keeps the trip enjoyable even when the weather is unsettled.",
                },
            ],
        },
        shared: {
            ...
            recommended: [
                {
                    ...
                    rationale: "A curated wardrobe keeps you looking polished without overpacking. Mix layers for variable weather.",
                },
            ],
        },
        shared: {
            ...
            recommended: [
                {
                    ...
                    rationale: "Cold plus wind means your layers should retain heat and block airflow for comfortable walks.",
                },
                {
                    id: "ps-hotdrinks",
                    text: "Bring a compact thermal option",
                    rationale: "Warm drinks can turn short breaks into relief; it’s a small item with big payoff.",
                },
            ],
        },
        shared: {
...
const inspirations = [
    {
        ...
        description: "A calm kit built around temperature swings and rainy pauses. Prioritize comfort and subtle texture.",
        imageUrl: "https://images.unsplash.com/photo-1526481280695-3c687fd5432c?auto=format&fit=crop&w=900&q=70",
    },
    {
        id: "insp-paris-editorial",
        destination: "Paris",
        title: "Editorial packing, effortless style",
        description: "A curated wardrobe with one hero look per day and smart layering for mild showers.",
        imageUrl: "https://images.unsplash.com/photo-1526779259212-6f74a8d7d8cb?auto=format&fit=crop&w=900&q=70",
    },
    {
        id: "insp-reykjavik-warm",
        destination: "Reykjavik",
        title: "Windproof warmth for the city",
        description: "Cold-ready layers and small comfort upgrades so you can roam longer without rushing back.",
        imageUrl: "https://images.unsplash.com/photo-1509099836639-18ba1792bb5b?auto=format&fit=crop&w=900&q=70",
    },
];
